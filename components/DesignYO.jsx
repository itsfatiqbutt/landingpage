...
const DesignYO = () => {
  return (
    <div className="w-full mt-[50px] md:mt-[214px] md:w-[98%] m-auto h-auto md:h-[828px] flex flex-col md:flex-row items-stretch justify-center gap-1 md:gap-8 py-8">
      {/* Image column */}
      <div className="md:w-1/2 w-full relative md:h-[828px] md:w-[653px] h-[157px] ">

        <div className='font-hiragino bg-[#806C63] flex items-center justify-center absolute z-10 h-[38px] w-full md:hidden font-[500] text-[12px] text-white  '>
      ...
      <div className="md:w-1/2 w-full h-auto px-6 mt-[10px] md:mt-[67px] md:px-0 flex flex-col items-center justify-center ">
        <h1 className="font-garamond md:mb-[-20px] text-black font-[500] italic text-[24px] md:text-[32px] [@media(min-width:1900px)]:text-[40px] w-full text-center">
        ...
        <ul className="self-start list-disc ml-6 space-y-2 md:space-y-4 mt-6 md:mt-13">
          <li className="font-helvetica text-[12px] md:text-[20px] [@media(min-width:1900px)]:text-[22px] text-black w-full">
            A tailored experience in our calm and inviting location in Hatton Garden.
          </li>
          <li className="font-helvetica text-[12px] md:text-[20px] [@media(min-width:1900px)]:text-[22px] text-black">
        ...
        {/* Centered CTA */}
        <button className="mt-10 w-[253px] font-[500] h-[30px] leading-[30px] md:h-[68px] md:leading-[68px] font-hiragino w-[80%] md:w-[60%] 2xl:w-[483px] rounded-[6px] bg-[#EDE7E5] text-[8px] md:text-[15px] text-black text-center">
  BOOK A COMPLIMENTARY CONSULTATION
</button>

        <p className='font-helvetica font-[500] text-[10px] md:text-[16px] [@media(min-width:1900px)]:text-[20px] mt-4'>
