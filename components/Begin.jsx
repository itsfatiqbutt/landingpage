...
const Begin = () => {
  return <div className='w-[95%] mx-auto flex flex-col md:flex-row items-center justify-between mt-[30px] md:mt-[208px]'>
    ...
    <div className='w-full md:w-[50%] px-4 flex flex-col gap-4 items-center'>
      <h1 className=' w-full font-garamond text-center mx-auto md:text-[32px] [@media(min-width:1900px)]:text-[40px] text-[20px] text-black'>
      Where it all begins...
      </h1>
      <p className='font-helvetica px-1 text-[10px] md:text-[16px] [@media(min-width:1900px)]:text-[20px] text-center'>Nestled in the heart of Hatton Garden, Flawless Fine Jewellery stands as a testament to the dedication to fine jewellery making in London’s historic jewellery quarter. Since 2014 our journey has been one of refining our craft to offer uncompromising quality, assembling a team of experts and enhancing our customer service. </p>
      <p className='font-helvetica px-1 text-[10px] md:text-[16px] [@media(min-width:1900px)]:text-[20px] text-center'>
