...
const Begin = () => {
  return <div className='w-[90%] mx-auto flex flex-col md:flex-row items-center justify-between mt-[50px]'>
    <div className='w-full md:w-[50%] h-auto'>
      <Image src="/images/where1.png" width={865} height={665} alt=
      "img" className="md:w-[865px] md:h-[665px]"></Image>
    </div>
    <div className='w-full md:w-[50%] px-4 flex flex-col gap-4 items-center'>
      <h1 className=' w-full font-garamond text-center mx-auto md:text-[40px] text-[20px] text-[black]'>
      Where it all begins...
      </h1>
      <p className='font-helvetica text-[10px] md:text-[20px] text-center'>Nestled in the heart of Hatton Garden, Flawless Fine Jewellery stands as a testament to the dedication to fine jewellery making in London’s historic jewellery quarter. Since 2014 our journey has been one of refining our craft to offer uncompromising quality, assembling a team of experts and enhancing our customer service. </p>
      <p className='font-helvetica text-[10px] md:text-[20px] text-center'>
...
your love made visible
      ...
      <button className='w-[50%] h-[30px] md:h-[65px] rounded-3px text-black text-[10px] md:text-[20px] bg-[#EDE7E5] flex items-center justify-center'>
      LEARN ABOUT US
      </button>
    </div>
  </div>;
