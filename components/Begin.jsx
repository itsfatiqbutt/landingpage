...
const Begin = () => {
  return <div className='w-[90%] mx-auto flex flex-col md:flex-row items-center justify-between mt-[50px]'>
    ...
    <div className='w-full md:w-[50%] px-4 flex flex-col gap-4 items-center'>
      ...
      <p className='font-helvetica px-4 text-[10px] md:text-[20px] text-center'>Nestled in the heart of Hatton Garden, Flawless Fine Jewellery stands as a testament to the dedication to fine jewellery making in London’s historic jewellery quarter. Since 2014 our journey has been one of refining our craft to offer uncompromising quality, assembling a team of experts and enhancing our customer service. </p>
      <p className='font-helvetica px-4 text-[10px] md:text-[20px] text-center'>
