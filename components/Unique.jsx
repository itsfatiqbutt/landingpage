...
const Unique = () => {
  ...
  <div className='w-full md:w-[90%] mx-auto mt-[50px] md:mt-[125px]  '>
      ...
      <div className='w-full mb-10 md:mb-0 md:w-[47%] flex flex-col gap-5'>
        ...
        <button className='font-hiragino [@media(min-width:1900px)]:text-[18px] rounded-[6px] cursor-pointer hover:bg-[#806C63] transition duration-500 md:text-[16px] font-medium bg-[#EDE7E5] w-[80%] md:w-[60%] mx-auto md:ml-0 text-[12px] h-[43px] flex items-center justify-center md:h-[65px] '>
   ...
   <div className='w-full md:w-[47%] flex flex-col gap-5'>
        ...
        <h1 className='font-helvetica font-[400] text-[20px] md:text-[32px] [@media(min-width:1900px)]:text-[36px] text-center md:text-left  text-black'>
        ...
        <button className='font-hiragino rounded-[6px] cursor-pointer hover:bg-[#806C63] transition duration-500 font-medium bg-[#EDE7E5] w-[80%] md:w-[60%] mx-auto md:ml-0 text-[12px] md:text-[16px]  [@media(min-width:1900px)]:text-[18px] h-[43px] flex items-center justify-center md:h-[65px] '>
