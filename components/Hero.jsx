...
const Hero = () => {
  return (
    <div className="w-full h-[417px] md:h-[597px] relative flex flex-col items-center justify-center gap-10">
      ...
      <h1 className='font-garamond z-20 relative text-[#EDE7E5]  font-[400] text-[32px] md:text-[48px]'> Love  Made Visible ...  </h1>
      <p className='z-20 relative text-white font-helvetica font-500 text-center text-[16px] w-[80%] md:w-[50%] md:text-[20px]'>
