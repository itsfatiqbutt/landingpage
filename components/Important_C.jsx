...
const Important_C = ({ heading, img, h2, para, tag, noWidth = false }) => {
  return (
    ...
    <div className={`w-full  flex flex-col gap-6`}>
      <h1 className="w-full text-center font-garamond italic font-[500] md:text-[28px] [@media(min-width:1900px)]:text-[32px] text-[20px] text-[#403526]">
        {heading}
      </h1>
      ...
      <p className="font-helvetica font-[400] text-[12px] md:text-[14px] [@media(min-width:1900px)]:text-[18px] text-black">
        {para}
      </p>
    </div>
  );
