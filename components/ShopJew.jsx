...
with the finest diamonds and heritage techniques.
    ...
    <Carousel className="w-full px-8 md:px-0  ">
          ...
          <Image src="/images/cr-left.svg" width={30} height={17} alt="img" className="absolute z-10 left-0 md:left-[-50px]
           top-1/2 -translate-y-1/2"></Image>
          <Image src="/images/cr-right.svg" width={30} height={17} alt="img" className="absolute z-10 right-0 md:right-[-50px] top-1/2 -translate-y-1/2"></Image>
        </Carousel>
    </div>
  </div>
  );
