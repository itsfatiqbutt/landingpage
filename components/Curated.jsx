...
const Curated = () => {
  return (
    <>
      ...
      <div className="w-full flex flex-col md:flex-row items-stretch justify-center mt-[80px] md:mt-[100px] gap-6 md:gap-0">
        ...
        <div className="order-2 md:order-1 w-full md:w-[80%]">
          <Carousel className="w-full px-6 md:px-20">
            ...
            <Image
              ...
              height={21}
              alt="Previous"
              className="absolute z-10 left-1  md:left-4 top-1/2 translate-y-[-40px] md:-translate-y-[50px] pointer-events-none w-[17px] h-[20px] md:w-[47px] md:h-[35px]"
            />
            <Image
              ...
              height={21}
              alt="Next"
              className="absolute z-10 right-1 md:right-4 top-1/2 translate-y-[-40px] md:-translate-y-[50px] pointer-events-none w-[17px] h-[20px] md:w-[47px] md:h-[35px]"
            />
          </Carousel>
        </div>
        ...
        <div className="order-1 md:order-2 w-full md:w-[21%] flex flex-col justify-center gap-5 pr-4">
          ...
          <button className="mx-auto w-[70%] font-[500] hidden md:w-full rounded-[6px] mt-4 h-[57px] border border-black/90 md:flex items-center justify-center md:text-[13px] text-[11px] text-black">
